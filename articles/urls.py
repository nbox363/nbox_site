...
from .views import ArticleView, ArticlesView, CreateArticleView, AddCommentView, current_category_view, AllCategoryView
...
urlpatterns = [
    ...
    path('all_categories/', AllCategoryView.as_view(), name='by_category'),
]
